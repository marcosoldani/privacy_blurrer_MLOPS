...
Uso (dalla root del progetto):
    ...
    python scripts/generate_manifest.py \
        --data_dir data/raw \
        --output data/manifests/dataset_v1.0.json \
        --val_ratio 0.2
"""
...
def generate(data_dir: str, output: str, val_ratio: float):
    ...
    manifest = {
        ...
        "source": (
            ...
            "tapakah68/supervisely-filtered-segmentation-person-dataset"
        ),
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", type=str, default="data/raw", help="Cartella con images/ e masks/"
    )
    parser.add_argument(
        "--output", type=str, default="data/manifests/dataset_v1.0.json", help="Path output JSON"
    )
